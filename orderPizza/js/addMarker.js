AFRAME.registerComponent("create-markers", {
    init: async function () {
        ...
        dishes.map(dish => {
            ...
            model.setAttribute('position', dish.model_geometary.position)
            model.setAttribute('rotation', dish.model_geometary.rotation)
            model.setAttribute('scale', dish.model_geometary.scale)
            ...
            dishTitle.setAttribute("text", { font: "monoid", color: "black", width: 1.8, height: 1, align: "center", value: dish.dishname.toUpperCase() });
            ...
            pricePlane.setAttribute("width", 0.8); pricePlane.setAttribute("height", 0.8); 
